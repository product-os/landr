...
module.exports = async ({
  ...
  try {
    ...
    data = require(`${process.env.HOME}/landr/cache/${ghConfig.owner}/${ghConfig.repo}.json`)
    actions.addLocals(data)
  }

  // if request went well write it to cache
  await fs.writeAsync(`${process.env.HOME}/landr/cache/${ghConfig.owner}/${ghConfig.repo}.json`, JSON.stringify(data, null, 2))
  actions.addLocals(data)
}
