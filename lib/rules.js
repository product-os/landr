...
module.exports = [
...

  {
    ...
    fn: (combination, routes, route, path) => {
      return path.length === 0 || route.scope === 'teamMember' || !combination.some((element) => {
  ...
  },
  {
    scope: [ 'Team' ],
    fn: (combination, routes, route, path) => {
      return route.scope === 'team' || !combination.some((element) => {
...

  {
    scope: [ 'Contributors' ],
    fn: (combination, routes, route, path) => {
      return path.length === 0 || path.includes('contributors') || !combination.some((element) => {
