...
module.exports = [
  ...
  (combination) => {
    ...
    return index === -1 || combination[index - 1].component === 'Navigation'
  },
  ...
  {
    scope: [ 'UserInfo' ],
    fn: (combination, routes, route, path) => {
      return (
        path.length === 0 ||
        route.scope === 'teamMember' ||
        !combination.some((element) => {
          return element.component === 'UserInfo'
        })
      )
    }
  },
  ...
  {
    scope: [ 'ReadmeSections' ],
    fn: (combination, routes, route, path) => {
      return (
        path.length === 0 ||
        !combination.some((element) => {
          return element.component === 'ReadmeSections'
        })
      )
    }
  },
  ...
  {
    scope: [ 'SetupAndConfiguration' ],
    fn: (combination, routes, route, path) => {
      return (
        path.length === 0 ||
        !combination.some((element) => {
          return element.component === 'SetupAndConfiguration'
        })
      )
    }
  },
  {
    scope: [ 'ReadmeLeftover' ],
    fn: (combination, routes, route, path) => {
      return (
        path.length === 0 ||
        !combination.some((element) => {
          return element.component === 'ReadmeLeftover'
        })
      )
    }
  },
...

  {
    ...
    fn: (combination, routes, route, path) => {
      return (
        ...
        path.includes('master-agreement') ||
        !combination.some((element) => {
          return element.component === 'LegalDocs'
        })
      )
    }
  },
  ...
  (combination) => {
    return (
      combination[0].component !== 'Jumbotron' &&
