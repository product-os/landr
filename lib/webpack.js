...
module.exports = (landrConfig, stage) => {
  return {
    ...
    resolve: {
      alias: {
        'pages': `${path.resolve(__dirname, '../node_modules')}/${landrConfig.theme}/pages`,
        'components': `${path.resolve(__dirname, '../node_modules')}/${landrConfig.theme}/components`,
        'theme': `${path.resolve(__dirname, '../node_modules')}/${landrConfig.theme}/theme`
      },
