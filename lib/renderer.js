...
const generatedTheme = JSON.parse(process.env.LANDR_THEME)
...
const theme = {
  ...
  colors: {
    primary: {
      main: generatedTheme.vibrant.normal.color,
      light: generatedTheme.vibrant.light.color,
      dark: generatedTheme.vibrant.dark.color
    },
    text: {
      main: '#2a506f',
      light: '#2a506f',
