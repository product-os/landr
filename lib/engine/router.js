 ...
 */
exports.getContext = (route, theme) => {
  /*
   * The theme gets added to the context object, overriding
   * any "theme" context that came through the router.
   */
  return Object.assign({}, route.context, {
    theme
  })
}
...
exports.findRouteByPath = (routes, path) => {
  for (const route of routes) {
    if (util.isDeepStrictEqual(exports.getPath(route), path)) {
      return route
    }
  }
