...
export default ({ children, styleTags, scriptTags, pages, ...props }) => {
  ...
  return (
    <html>
      <head>
        <title>{`${props.locals.repository.name} - ${props.locals.config.settings.lead || props.locals.repository.description}`}</title>
        ...
        <meta name="og:description" content={props.locals.config.settings.lead || props.locals.repository.description} />
