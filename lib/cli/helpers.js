...
/**
* @module Versionist.CLI.helpers
**/

const chalk = require('chalk');

/**
* @summary Exits process and logs debug + help info to console
* @function
* @public
*
* @param {Object} error - file paths for files that may or may not exist
*
* @example
