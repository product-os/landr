...
React is flexible and can be used in a constiety of projects. You can create new apps with it, but you can also gradually introduce it into an existing codebase without doing a rewrite.
